...
function Comp({ id, children, on, onHover, onSelect, label }) {
  return (
    <g data-comp={id} className={on ? 'fc-on' : ''} tabIndex={0} role="button" aria-label={label}
        ...
        <g transform="translate(230,56)">
          ...
          {failure && <g pointerEvents="none">
            ...
            <g transform="translate(120,-44)">
              ...
              <text x="32" y="38" fontSize="10" fill={T.ink} opacity="0.85" fontFamily="Helvetica, Arial, sans-serif">FirstCall 24/7 Emergency — technician dispatched</text>
            </g>
          </g>}
          {optimized && <g pointerEvents="none">
            <g transform="translate(-205,-46)">
              ...
              <text x="28" y="30" fontSize="9.5" fill={T.ink} opacity="0.8" fontFamily="Helvetica, Arial, sans-serif">Retrofit + sequencing — efficiency improving</text>
            </g>
          </g>}
        </g>
      </svg>
